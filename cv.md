...
* jQuery;
* JavaScript;
* PHP *(as Wordpress fullstack developer)*;
* BEM, Sass, responsive and adaptive layout;
* Gulp, Webpack;
* GitHub, GitLab;
* Wordpress/WooCommerce *(as fullstack developer)*, Yii 2, Joomla, PrestaShop *(as front-end developer)*;
...
Reading interesting books about human nature, psychology, history, and exciting novels, thrillers. 
Also cooking new dishes from different cuisines of the world, as well as pastries and desserts. 
